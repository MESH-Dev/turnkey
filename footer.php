...
<footer>
  ...
  <!-- <//?php
  //Show only on the homepage?  Uncomment below
 ...
 //  $imageURL = $imageArray[$c];
  ...
  ?>
  <!<script type="text/javascript" src="https://sealserver.trustwave.com/seal.js?style=invert&code=9cbea706a3bd4e12b1e6fb28d0cccc61"></script>
  <//?php } ?> -->
